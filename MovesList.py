...
punch = Move("punch", "i", 1, 1,13,1,(100,100),1)
kick = Move("kick", "k", 3, 10,1,3,(200,100),1)
specialmove = Move("special", "26k", 3, 6,3,0,(300,300),2)
dashleft = Move("dashleft","44",2,0,6,0, 0, -20)
dashright = Move("dashright","66",2,0,6,0,0,20)
